...
* Build Engineer (now Red Hat, past: Red Hat/Linaro, Canonical/Linaro, OpenedHand, OpenEmbedded, BugLabs)
...
* maintainer of [Linux system calls table](https://gpages.juszkiewicz.com.pl/syscalls-table/syscalls.html) ([git repo](https://github.com/hrw/syscalls-table))
  * and Python system-calls package to check name/number and availability of system calls
* collector of AArch64 SoC features information ([available as table](https://gpages.juszkiewicz.com.pl/arm-socs-table/arm-socs.html))
  * [table of Arm cpu cores](https://gpages.juszkiewicz.com.pl/arm-socs-table/arm-cpu-cores.html) information as a side effect
* FOSDEM fan with own [webpage with FOSDEM schedule with links to slides/videos](https://gpages.juszkiewicz.com.pl/fosdem-videos/)
